...
const ImageSlider = () => {
  ...
  return (
    <div id='foods' className="max-w-[1400px] h-[580px] w-full m-auto py-16 px-4 relative group scroll-m-[40px]">
      <div
        className="w-full h-full rounded-2xl bg-center bg-cover duration-500" style={{backgroundImage: `url(${slides[currentIndex].url})`}}
      >
      </div>
      {/* Left Arrow */}
